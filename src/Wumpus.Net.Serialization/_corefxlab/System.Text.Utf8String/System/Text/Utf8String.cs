...
namespace System.Text.Utf8
{
    ...
    public partial struct Utf8String
    {
        ...
        private const int _stringNotFound = -1;

        static Utf8String _empty => default;
        ...
        public static explicit operator Utf8String(ArraySegment<byte> utf8Bytes) => new Utf8String(utf8Bytes);
        ...
        {
            var status = Encoders.Utf8.ToUtf16Length(Bytes, out int needed);
            ...
            status = Encoders.Utf8.ToUtf16(Bytes, utf16, out int consumed, out int written);
            if (status != Buffers.TransformationStatus.Done)
                return string.Empty;
        ...
        public bool ReferenceEquals(Utf8String other) => _buffer == other._buffer;
        ...
        public bool Equals(string other)
        {
            ...
            var otherEnumerator = new Utf16LittleEndianCodePointEnumerator(other);
        ...
        public bool StartsWith(Utf8String value)
        {
            ...
            return Substring(0, value.Length).Equals(value);
        }
        ...
        public bool EndsWith(Utf8String value)
        {
            ...
            return Substring(Length - value.Length, value.Length).Equals(value);
        }
